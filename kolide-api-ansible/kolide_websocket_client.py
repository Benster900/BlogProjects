...
def authenticateToKolide() -> str:
  ...
  if environ.get('KOLIDE_TOKEN') is not None and environ.get('KOLIDE_BASE_URL') is not None:
  ...
  # Authenticate to Kokide with username and password
    ...
    payload = {
      "Username": kolide_username,
      "Password": kolide_password
    }
...
if __name__ == "__main__":
  ...
  parser.add_argument('--campaign_id', type=int, help='an integer for the accumulator')
